...
function ListaKategorii()
{
    ...
    while($res = mysqli_fetch_array($result)) {
        ...
        $content .= "<td><a href=\"?strona=administracja&id=$res[id]&showCategory=true\">Edytuj</a> | <a href=\"?strona=administracja&delete_category=$res[id]\" onClick=\"return confirm('Czy na pewno usunąć ?')\">Usuń</a></td>";
    }
